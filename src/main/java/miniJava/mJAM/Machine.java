...
public final class Machine {
	...
	/**
	 * Places an instruction, with the given fields, into the next position in the
	 * code store
	 * 
	 * @param op - operation
	 * @param n  - length
	...
	/**
	 * emit "call primitive operation" (operation built-in to mJAM). This generates
	 * CALL primitiveop[PB]
	 */
	...
	/**
	 * emit operations without arguments. These are operations like LOADI and STOREI
	 */
	...
	/**
	 * emit operation with register r and integer displacement. These are operations
	 * like JUMP 25[CB] and LOAD 6[LB]
	 */
	...
	/**
	 * emit operation with n field, and register r and integer displacement. These
	 * are operations like JUMPIF (1) 25[CB]. In the assembly code the value of n is
	 * shown in parens.
	 */
	...
	/**
	 * emit operation with integer n, r, d. These are operations like RETURN (1) 3
	 * and HALT (4) 0. For RETURN the value of d is the number of caller args to pop
	 * off the callers stack and n is the number of values to return at caller stack
	...
	// DATA REPRESENTATION
	public final static int booleanSize = 1, characterSize = 1, integerSize = 1, addressSize = 1, linkDataSize = 3 * addressSize, // caller's LB, OB, RA
